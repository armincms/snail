...
trait Authorizable
{
     ...
     * @return bool
     */
    public function authorizedToAdd(SnailRequest $request, $model)
    {
        if (! static::authorizable()) {
            return true;
        }
     ...
     * @return bool
     */
    public function authorizedToAttachAny(SnailRequest $request, $model)
    {
        if (! static::authorizable()) {
            return true;
        }
     ...
     * @return bool
     */
    public function authorizedToAttach(SnailRequest $request, $model)
    {
        if (! static::authorizable()) {
            return true;
        }
     ...
     * @return bool
     */
    public function authorizedToDetach(SnailRequest $request, $model, $relationship)
    {
        if (! static::authorizable()) {
            return true;
        }
